...
const searchMovie = (e) => {
  axios.get(`http://www.omdbapi.com/?apikey=8321507c&s=${e}`).then(response => {
  ...
  <nav aria-label="Page navigation example">
    <ul class="flex list-style-none">
      ...
      <li class="page-item" v-for="item in totalResults" :key="item.id"><a
          class="page-link relative block py-1.5 px-3 rounded border-0 bg-transparent outline-none transition-all duration-300 rounded text-white hover:text-gray-800 hover:bg-gray-200 focus:shadow-none"
